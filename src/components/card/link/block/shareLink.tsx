...
const ShareLink: React.FC<LinkCardShareLinkProps> = ({ link }) => (
  <a
    ...
    className="flex items-center justify-start ml-2 sm:ml-4 group"
  >
    <i className="font-semibold text-green-300 transition duration-300 ease-in-out delay-75 text-md sm:text-xl bx bxs-share-alt group-hover:text-green-500"></i>
